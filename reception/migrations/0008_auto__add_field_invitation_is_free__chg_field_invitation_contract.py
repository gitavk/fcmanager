...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invitation.is_free'
        db.add_column(u'reception_invitation', 'is_free',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Invitation.contract'
        db.alter_column(u'reception_invitation', 'contract_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.Contract'], null=True))

    def backwards(self, orm):
        # Deleting field 'Invitation.is_free'
        db.delete_column(u'reception_invitation', 'is_free')


        # User chose to not deal with backwards NULL issues for 'Invitation.contract'
        raise RuntimeError("Cannot reverse this migration. 'Invitation.contract' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Invitation.contract'
        db.alter_column(u'reception_invitation', 'contract_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.Contract']))
