...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reception_guest', 'phone', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Guest.phone'
        db.alter_column(u'reception_guest', 'phone', self.gf('django.db.models.fields.IntegerField')())
