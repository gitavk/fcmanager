...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Guest.patronicname'
        db.delete_column(u'reception_guest', 'patronicname')

        # Adding field 'Guest.patronymic'
        db.add_column(u'reception_guest', 'patronymic',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=30),
                      keep_default=False)

        # Adding unique constraint on 'Guest', fields ['firstname', 'lastname', 'patronymic', 'born']
        db.create_unique(u'reception_guest', ['firstname', 'lastname', 'patronymic', 'born'])


    def backwards(self, orm):
        # Removing unique constraint on 'Guest', fields ['firstname', 'lastname', 'patronymic', 'born']
        db.delete_unique(u'reception_guest', ['firstname', 'lastname', 'patronymic', 'born'])

        # Adding field 'Guest.patronicname'
        db.add_column(u'reception_guest', 'patronicname',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=30),
                      keep_default=False)

        # Deleting field 'Guest.patronymic'
        db.delete_column(u'reception_guest', 'patronymic')
