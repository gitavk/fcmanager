...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReadBy'
        db.create_table(u'reception_readby', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('readtime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'])),
            ('reminder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.Reminder'])),
        ))
        db.send_create_signal(u'reception', ['ReadBy'])


    def backwards(self, orm):
        # Deleting model 'ReadBy'
        db.delete_table(u'reception_readby')
