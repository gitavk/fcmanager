...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reminder.wdays'
        db.alter_column(u'reception_reminder', 'wdays', self.gf('django.db.models.fields.CharField')(max_length=14, null=True))

    def backwards(self, orm):

        # Changing field 'Reminder.wdays'
        db.alter_column(u'reception_reminder', 'wdays', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=7, null=True))
