...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.manager'
        db.alter_column(u'person_client', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

    def backwards(self, orm):

        # Changing field 'Client.manager'
        db.alter_column(u'person_client', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
