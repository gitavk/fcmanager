...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Client', fields ['first_name', 'last_name', 'patronymic', 'born_date']
        db.create_unique(u'person_client', ['first_name', 'last_name', 'patronymic', 'born_date'])


    def backwards(self, orm):
        # Removing unique constraint on 'Client', fields ['first_name', 'last_name', 'patronymic', 'born_date']
        db.delete_unique(u'person_client', ['first_name', 'last_name', 'patronymic', 'born_date'])
