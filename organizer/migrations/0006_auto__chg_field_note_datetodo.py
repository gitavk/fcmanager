...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Note.datetodo'
        db.alter_column(u'organizer_note', 'datetodo', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Note.datetodo'
        db.alter_column(u'organizer_note', 'datetodo', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'organizer.note': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'datetodo': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
