...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'guest'
        db.create_table(u'organizer_guest', (
            ...
            ('patronymic', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ...
            ('is_client', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'organizer', ['guest'])


    def backwards(self, orm):
        # Deleting model 'guest'
        db.delete_table(u'organizer_guest')
