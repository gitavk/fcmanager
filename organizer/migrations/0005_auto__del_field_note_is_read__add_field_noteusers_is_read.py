...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.is_read'
        db.delete_column(u'organizer_note', 'is_read')

        # Adding field 'NoteUsers.is_read'
        db.add_column(u'organizer_noteusers', 'is_read',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Note.is_read'
        db.add_column(u'organizer_note', 'is_read',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'NoteUsers.is_read'
        db.delete_column(u'organizer_noteusers', 'is_read')
