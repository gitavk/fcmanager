...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Employee', fields ['card']
        db.create_unique(u'employees_employee', ['card'])


    def backwards(self, orm):
        # Removing unique constraint on 'Employee', fields ['card']
        db.delete_unique(u'employees_employee', ['card'])
