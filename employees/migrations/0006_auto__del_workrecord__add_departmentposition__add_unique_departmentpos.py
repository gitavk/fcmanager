...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DepartmentPosition'
        db.create_table(u'employees_departmentposition', (
            ...
            ('department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Department'], on_delete=models.PROTECT)),
        ))
        db.send_create_signal(u'employees', ['DepartmentPosition'])

        # Adding unique constraint on 'DepartmentPosition', fields ['position', 'department']
        db.create_unique(u'employees_departmentposition', ['position_id', 'department_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DepartmentPosition', fields ['position', 'department']
        db.delete_unique(u'employees_departmentposition', ['position_id', 'department_id'])
        ...
        # Deleting model 'DepartmentPosition'
        db.delete_table(u'employees_departmentposition')
