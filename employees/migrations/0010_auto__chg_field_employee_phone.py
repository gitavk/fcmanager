...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'employees_employee', 'phone', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Employee.phone'
        db.alter_column(u'employees_employee', 'phone', self.gf('django.db.models.fields.IntegerField')(null=True))
