...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'employees_employee', (
            ...
            ('card', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('login', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'])),
        ))
        db.send_create_signal(u'employees', ['Employee'])

        # Adding model 'Visits'
        db.create_table(u'employees_visits', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'employees', ['Visits'])
        ...
        db.send_create_signal(u'employees', ['Department'])

        # Adding model 'Position'
        db.create_table(u'employees_position', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
        ))
        db.send_create_signal(u'employees', ['Position'])
        ...
        db.create_table(u'employees_workrecord', (
            ...
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Employee'])),
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Position'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'employees_visits')

        # Deleting model 'Department'
        db.delete_table(u'employees_department')

        # Deleting model 'Position'
        db.delete_table(u'employees_position')
    ...
    models = {
        ...
        u'employees.employee': {
            ...
            'login': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.User']"}),
        ...
        u'employees.workrecord': {
            ...
            'department': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employees.Department']"}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employees.Employee']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employees.Position']"})
        }
    }
