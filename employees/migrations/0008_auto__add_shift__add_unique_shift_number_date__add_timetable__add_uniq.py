...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Shift'
        db.create_table(u'employees_shift', (
        ...
        db.send_create_signal(u'employees', ['Shift'])

        # Adding unique constraint on 'Shift', fields ['number', 'date']
        db.create_unique(u'employees_shift', ['number', 'date'])

        # Adding model 'timetable'
        db.create_table(u'employees_timetable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('shift', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Shift'], on_delete=models.PROTECT)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Employee'], on_delete=models.PROTECT)),
        ))
        db.send_create_signal(u'employees', ['timetable'])

        # Adding unique constraint on 'timetable', fields ['shift', 'date']
        db.create_unique(u'employees_timetable', ['shift_id', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'timetable', fields ['shift', 'date']
        db.delete_unique(u'employees_timetable', ['shift_id', 'date'])

        # Removing unique constraint on 'Shift', fields ['number', 'date']
        db.delete_unique(u'employees_shift', ['number', 'date'])

        # Deleting model 'Shift'
        db.delete_table(u'employees_shift')

        # Deleting model 'timetable'
        db.delete_table(u'employees_timetable')
    ...
    models = {
        ...
        u'employees.shift': {
            'Meta': {'unique_together': "(('number', 'date'),)", 'object_name': 'Shift'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'employees.timetable': {
            'Meta': {'unique_together': "(('shift', 'date'),)", 'object_name': 'timetable'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employees.Employee']", 'on_delete': 'models.PROTECT'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shift': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employees.Shift']", 'on_delete': 'models.PROTECT'})
        },
        u'employees.visits': {
