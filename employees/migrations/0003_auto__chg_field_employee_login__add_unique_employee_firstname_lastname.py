...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'employees_employee', 'login_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], null=True, on_delete=models.PROTECT))
        # Adding unique constraint on 'Employee', fields ['firstname', 'lastname', 'patronymic', 'born']
        db.create_unique(u'employees_employee', ['firstname', 'lastname', 'patronymic', 'born'])


    def backwards(self, orm):
        # Removing unique constraint on 'Employee', fields ['firstname', 'lastname', 'patronymic', 'born']
        db.delete_unique(u'employees_employee', ['firstname', 'lastname', 'patronymic', 'born'])


        # Changing field 'Employee.login'
        db.alter_column(u'employees_employee', 'login_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.User'], on_delete=models.PROTECT))
