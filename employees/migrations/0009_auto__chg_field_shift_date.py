...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shift.date'
        db.alter_column(u'employees_shift', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Shift.date'
        db.alter_column(u'employees_shift', 'date', self.gf('django.db.models.fields.DateField')())
