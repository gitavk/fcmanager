...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.bonus_visit'
        db.alter_column(u'contract_contract', 'bonus_visit', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Contract.bonus_visit'
        db.alter_column(u'contract_contract', 'bonus_visit', self.gf('django.db.models.fields.IntegerField')())
