...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.date_start'
        db.alter_column(u'contract_contract', 'date_start', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Contract.date_start'
        db.alter_column(u'contract_contract', 'date_start', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 6, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
