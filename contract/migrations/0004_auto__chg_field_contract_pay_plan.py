...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.pay_plan'
        db.alter_column(u'contract_contract', 'pay_plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.PayPlan'], null=True))

    def backwards(self, orm):

        # Changing field 'Contract.pay_plan'
        db.alter_column(u'contract_contract', 'pay_plan_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contract.PayPlan']))
