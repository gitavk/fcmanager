...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.is_open_date'
        db.add_column(u'contract_contract', 'is_open_date',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.is_open_date'
        db.delete_column(u'contract_contract', 'is_open_date')
