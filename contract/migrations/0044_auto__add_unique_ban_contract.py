...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Ban', fields ['contract']
        db.create_unique(u'contract_ban', ['contract_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ban', fields ['contract']
        db.delete_unique(u'contract_ban', ['contract_id'])
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
