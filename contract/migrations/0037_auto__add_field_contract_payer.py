...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.payer'
        db.add_column(u'contract_contract', 'payer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='contract_payer', to=orm['person.Client']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.payer'
        db.delete_column(u'contract_contract', 'payer_id')
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
