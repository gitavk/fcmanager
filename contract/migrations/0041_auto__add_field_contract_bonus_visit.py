...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.bonus_visit'
        db.add_column(u'contract_contract', 'bonus_visit',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.bonus_visit'
        db.delete_column(u'contract_contract', 'bonus_visit')
    ...
    models = {
        ...
        u'contract.contract': {
            ...
            'bonus_visit': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
