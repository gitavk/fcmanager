...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.is_current'
        db.add_column(u'contract_contract', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.is_current'
        db.delete_column(u'contract_contract', 'is_current')
