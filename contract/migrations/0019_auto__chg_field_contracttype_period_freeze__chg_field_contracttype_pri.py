...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContractType.period_freeze'
        db.alter_column(u'contract_contracttype', 'period_freeze', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ContractType.price'
        db.alter_column(u'contract_contracttype', 'price', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ContractType.max_visit'
        db.alter_column(u'contract_contracttype', 'max_visit', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ContractType.period_activation'
        db.alter_column(u'contract_contracttype', 'period_activation', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'ContractType.period_freeze'
        db.alter_column(u'contract_contracttype', 'period_freeze', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'ContractType.price'
        db.alter_column(u'contract_contracttype', 'price', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'ContractType.max_visit'
        db.alter_column(u'contract_contracttype', 'max_visit', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'ContractType.period_activation'
        db.alter_column(u'contract_contracttype', 'period_activation', self.gf('django.db.models.fields.SmallIntegerField')())
