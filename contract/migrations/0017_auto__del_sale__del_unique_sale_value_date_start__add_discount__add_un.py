...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Sale', fields ['value', 'date_start']
        db.delete_unique(u'contract_sale', ['value', 'date_start'])

        # Deleting model 'Sale'
        db.delete_table(u'contract_sale')

        # Adding model 'Discount'
        db.create_table(u'contract_discount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('date_start', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('date_end', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'contract', ['Discount'])

        # Adding unique constraint on 'Discount', fields ['value', 'date_start']
        db.create_unique(u'contract_discount', ['value', 'date_start'])

        # Deleting field 'Contract.sale'
        db.delete_column(u'contract_contract', 'sale_id')

        # Adding field 'Contract.discount'
        db.add_column(u'contract_contract', 'discount',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.Discount'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Discount', fields ['value', 'date_start']
        db.delete_unique(u'contract_discount', ['value', 'date_start'])

        # Adding model 'Sale'
        db.create_table(u'contract_sale', (
            ('date_end', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_start', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('value', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'contract', ['Sale'])

        # Adding unique constraint on 'Sale', fields ['value', 'date_start']
        db.create_unique(u'contract_sale', ['value', 'date_start'])

        # Deleting model 'Discount'
        db.delete_table(u'contract_discount')

        # Adding field 'Contract.sale'
        db.add_column(u'contract_contract', 'sale',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.Sale'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Contract.discount'
        db.delete_column(u'contract_contract', 'discount_id')
