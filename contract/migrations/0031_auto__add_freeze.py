...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Freeze'
        db.create_table(u'contract_freeze', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_start', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('date_end', self.gf('django.db.models.fields.DateField')()),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.Contract'])),
            ('is_closed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'contract', ['Freeze'])


    def backwards(self, orm):
        # Deleting model 'Freeze'
        db.delete_table(u'contract_freeze')
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
