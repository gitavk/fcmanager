...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeriodTimeType.is_active'
        db.add_column(u'contract_periodtimetype', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeriodTimeType.is_active'
        db.delete_column(u'contract_periodtimetype', 'is_active')
