...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Freeze.date_start'
        db.alter_column(u'contract_freeze', 'date_start', self.gf('django.db.models.fields.DateField')())
        # Adding unique constraint on 'Freeze', fields ['date_start', 'contract']
        db.create_unique(u'contract_freeze', ['date_start', 'contract_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Freeze', fields ['date_start', 'contract']
        db.delete_unique(u'contract_freeze', ['date_start', 'contract_id'])


        # Changing field 'Freeze.date_start'
        db.alter_column(u'contract_freeze', 'date_start', self.gf('django.db.models.fields.DateField')(auto_now=True))
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'contract.visits': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_online': ('django.db.models.fields.SmallIntegerField', [], {'default': '-1'}),
