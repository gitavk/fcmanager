...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.date_end'
        db.alter_column(u'contract_contract', 'date_end', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Contract.date_end'
        db.alter_column(u'contract_contract', 'date_end', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'contract.ban': {
            ...
            'contract': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contract.Contract']", 'unique': 'True', 'on_delete': 'models.PROTECT'}),
        ...
        u'contract.bonus': {
            ...
            'contract': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contract.Contract']", 'on_delete': 'models.PROTECT'}),
            'date_end': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'contract.freeze': {
            ...
            'date_end': ('django.db.models.fields.DateField', [], {}),
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
