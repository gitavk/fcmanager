...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.date_joined'
        db.add_column(u'contract_contract', 'date_joined',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.date_joined'
        db.delete_column(u'contract_contract', 'date_joined')
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_end': ('django.db.models.fields.DateField', [], {}),
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 9, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
