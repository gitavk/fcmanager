...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContractText.person'
        db.alter_column(u'contract_contracttext', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

        # Changing field 'ContractType.modified_by'
        db.alter_column(u'contract_contracttype', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

        # Changing field 'Contract.manager'
        db.alter_column(u'contract_contract', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

        # Changing field 'Visits.is_online'
        db.alter_column(u'contract_visits', 'is_online', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'ContractText.person'
        db.alter_column(u'contract_contracttext', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'ContractType.modified_by'
        db.alter_column(u'contract_contracttype', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Contract.manager'
        db.alter_column(u'contract_contract', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Visits.is_online'
        db.alter_column(u'contract_visits', 'is_online', self.gf('django.db.models.fields.SmallIntegerField')())
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
