...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sale.date_end'
        db.alter_column(u'contract_sale', 'date_end', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Sale.date_end'
        db.alter_column(u'contract_sale', 'date_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Sale.date_start'
        db.alter_column(u'contract_sale', 'date_start', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
