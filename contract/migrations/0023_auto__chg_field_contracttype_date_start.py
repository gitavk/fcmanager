...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContractType.date_start'
        db.alter_column(u'contract_contracttype', 'date_start', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'ContractType.date_start'
        db.alter_column(u'contract_contracttype', 'date_start', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
