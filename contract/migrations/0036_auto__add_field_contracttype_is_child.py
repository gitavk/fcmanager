...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContractType.is_child'
        db.add_column(u'contract_contracttype', 'is_child',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContractType.is_child'
        db.delete_column(u'contract_contracttype', 'is_child')
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
