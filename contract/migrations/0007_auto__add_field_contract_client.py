...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'contract_contract', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['person.client']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.client'
        db.delete_column(u'contract_contract', 'client_id')
