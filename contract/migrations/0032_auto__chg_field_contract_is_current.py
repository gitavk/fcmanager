...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.is_current'
        db.alter_column(u'contract_contract', 'is_current', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Contract.is_current'
        db.alter_column(u'contract_contract', 'is_current', self.gf('django.db.models.fields.BooleanField')())
