...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.date'
        db.alter_column(u'contract_contract', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Contract.date'
        db.alter_column(u'contract_contract', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
