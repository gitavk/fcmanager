...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ban'
        db.create_table(u'contract_ban', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.Contract'], on_delete=models.PROTECT)),
        ...
        db.send_create_signal(u'contract', ['Ban'])


    def backwards(self, orm):
        # Deleting model 'Ban'
        db.delete_table(u'contract_ban')
    ...
    models = {
        ...
        u'contract.freeze': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
