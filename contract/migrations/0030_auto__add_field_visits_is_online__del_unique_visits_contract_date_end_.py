...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visits.is_online'
        db.add_column(u'contract_visits', 'is_online',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)

        # Adding unique constraint on 'Visits', fields ['contract', 'is_online']
        db.create_unique(u'contract_visits', ['contract_id', 'is_online'])


    def backwards(self, orm):
        # Removing unique constraint on 'Visits', fields ['contract', 'is_online']
        db.delete_unique(u'contract_visits', ['contract_id', 'is_online'])

        # Deleting field 'Visits.is_online'
        db.delete_column(u'contract_visits', 'is_online')

        # Adding unique constraint on 'Visits', fields ['contract', 'date_end']
        db.create_unique(u'contract_visits', ['contract_id', 'date_end'])
