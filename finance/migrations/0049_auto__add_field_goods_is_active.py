...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goods.is_active'
        db.add_column(u'finance_goods', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goods.is_active'
        db.delete_column(u'finance_goods', 'is_active')
    ...
    models = {
        ...
        u'finance.goods': {
            ...
            'pay_days': ('django.db.models.fields.SmallIntegerField', [], {'default': '0', 'blank': 'True'}),
