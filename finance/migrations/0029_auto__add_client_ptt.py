...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Client_PTT'
        db.create_table(u'finance_client_ptt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Client'], on_delete=models.PROTECT)),
            ('trainer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Employee'], on_delete=models.PROTECT)),
            ('seller', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], on_delete=models.PROTECT)),
            ('ptt', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], on_delete=models.PROTECT)),
            ('is_card', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('payment_type', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'finance', ['Client_PTT'])


    def backwards(self, orm):
        # Deleting model 'Client_PTT'
        db.delete_table(u'finance_client_ptt')
    ...
    models = {
        ...
        u'finance.client_ptt': {
            ...
            'payment_type': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'ptt': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['finance.Goods']", 'on_delete': 'models.PROTECT'}),
            'seller': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.User']", 'on_delete': 'models.PROTECT'}),
            'trainer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employees.Employee']", 'on_delete': 'models.PROTECT'})
        },
        u'finance.credits': {
