...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreditsHistory.employee'
        db.add_column(u'finance_creditshistory', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Employee'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'Credits.employee'
        db.add_column(u'finance_credits', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Employee'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CreditsHistory.employee'
        db.delete_column(u'finance_creditshistory', 'employee_id')

        # Deleting field 'Credits.employee'
        db.delete_column(u'finance_credits', 'employee_id')
