...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CreditsHistory.payment_user'
        db.alter_column(u'finance_creditshistory', 'payment_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

        # Changing field 'Credits.user'
        db.alter_column(u'finance_credits', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

    def backwards(self, orm):

        # Changing field 'CreditsHistory.payment_user'
        db.alter_column(u'finance_creditshistory', 'payment_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Credits.user'
        db.alter_column(u'finance_credits', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'finance.goods': {
            'Meta': {'unique_together': "(('name', 'provider'),)", 'object_name': 'Goods'},
