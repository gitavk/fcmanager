...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Goods.register_units'
        db.delete_column(u'finance_goods', 'register_units_id')

        # Adding field 'Goods.department'
        db.add_column(u'finance_goods', 'department',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Goods.register_units'
        db.add_column(u'finance_goods', 'register_units',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.RegisterUnits'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Deleting field 'Goods.department'
        db.delete_column(u'finance_goods', 'department')
