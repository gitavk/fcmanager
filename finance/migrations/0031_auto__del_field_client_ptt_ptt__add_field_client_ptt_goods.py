...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Client_PTT.ptt'
        db.delete_column(u'finance_client_ptt', 'ptt_id')

        # Adding field 'Client_PTT.goods'
        db.add_column(u'finance_client_ptt', 'goods',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['finance.Goods'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Client_PTT.ptt'
        db.add_column(u'finance_client_ptt', 'ptt',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['finance.Goods'], on_delete=models.PROTECT),
                      keep_default=False)

        # Deleting field 'Client_PTT.goods'
        db.delete_column(u'finance_client_ptt', 'goods_id')
