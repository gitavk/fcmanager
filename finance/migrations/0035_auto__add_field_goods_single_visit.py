...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goods.single_visit'
        db.add_column(u'finance_goods', 'single_visit',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goods.single_visit'
        db.delete_column(u'finance_goods', 'single_visit')
