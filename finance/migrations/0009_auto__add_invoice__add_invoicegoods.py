...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InvoiceGoods'
        db.create_table(u'finance_invoicegoods', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Invoice'])),
        ...
        db.send_create_signal(u'finance', ['InvoiceGoods'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'InvoiceGoods'
        db.delete_table(u'finance_invoicegoods')
