...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoodsProvider.goods'
        db.alter_column(u'finance_goodsprovider', 'goods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], on_delete=models.PROTECT))

        # Changing field 'Price.goods'
        db.alter_column(u'finance_price', 'goods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], on_delete=models.PROTECT))

        # Changing field 'BarCode.goods'
        db.alter_column(u'finance_barcode', 'goods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'GoodsProvider.goods'
        db.alter_column(u'finance_goodsprovider', 'goods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods']))

        # Changing field 'Price.goods'
        db.alter_column(u'finance_price', 'goods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods']))

        # Changing field 'BarCode.goods'
        db.alter_column(u'finance_barcode', 'goods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods']))
