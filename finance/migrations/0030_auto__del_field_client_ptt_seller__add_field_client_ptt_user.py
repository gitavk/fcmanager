...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Client_PTT.seller'
        db.delete_column(u'finance_client_ptt', 'seller_id')

        # Adding field 'Client_PTT.user'
        db.add_column(u'finance_client_ptt', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.User'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Client_PTT.seller'
        db.add_column(u'finance_client_ptt', 'seller',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.User'], on_delete=models.PROTECT),
                      keep_default=False)

        # Deleting field 'Client_PTT.user'
        db.delete_column(u'finance_client_ptt', 'user_id')
