...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invitation.client'
        db.add_column(u'finance_invitation', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Client'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Invitation.guest'
        db.alter_column(u'finance_invitation', 'guest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.Guest'], null=True))

    def backwards(self, orm):
        # Deleting field 'Invitation.client'
        db.delete_column(u'finance_invitation', 'client_id')


        # Changing field 'Invitation.guest'
        db.alter_column(u'finance_invitation', 'guest_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['reception.Guest']))
