...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Credits.date'
        db.alter_column(u'finance_credits', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Credits.date'
        db.alter_column(u'finance_credits', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
