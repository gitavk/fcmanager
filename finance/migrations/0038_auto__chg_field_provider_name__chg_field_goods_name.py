...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'finance_provider', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Goods.name'
        db.alter_column(u'finance_goods', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Provider.name'
        db.alter_column(u'finance_provider', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))

        # Changing field 'Goods.name'
        db.alter_column(u'finance_goods', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
