...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditsHistory.ptt_card'
        db.add_column(u'finance_creditshistory', 'ptt_card',
                      self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Credits.ptt_card'
        db.add_column(u'finance_credits', 'ptt_card',
                      self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditsHistory.ptt_card'
        db.delete_column(u'finance_creditshistory', 'ptt_card')

        # Deleting field 'Credits.ptt_card'
        db.delete_column(u'finance_credits', 'ptt_card')
