...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'finance_warehouse')

        # Adding field 'InvoiceGoods.balance'
        db.add_column(u'finance_invoicegoods', 'balance',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'finance_warehouse', (
            ('balance', self.gf('django.db.models.fields.IntegerField')()),
            (u'invoicegoods_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['finance.InvoiceGoods'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'finance', ['Warehouse'])

        # Deleting field 'InvoiceGoods.balance'
        db.delete_column(u'finance_invoicegoods', 'balance')
