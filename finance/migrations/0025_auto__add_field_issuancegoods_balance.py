...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssuanceGoods.balance'
        db.add_column(u'finance_issuancegoods', 'balance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssuanceGoods.balance'
        db.delete_column(u'finance_issuancegoods', 'balance')
