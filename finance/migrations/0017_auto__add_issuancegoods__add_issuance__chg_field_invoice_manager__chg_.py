...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssuanceGoods'
        db.create_table(u'finance_issuancegoods', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issuance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Issuance'], on_delete=models.PROTECT)),
            ('goods', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.InvoiceGoods'], on_delete=models.PROTECT)),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ))
        db.send_create_signal(u'finance', ['IssuanceGoods'])

        # Adding model 'Issuance'
        db.create_table(u'finance_issuance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('market', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Market'], on_delete=models.PROTECT)),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], on_delete=models.PROTECT)),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ))
        db.send_create_signal(u'finance', ['Issuance'])


        # Changing field 'Invoice.manager'
        db.alter_column(u'finance_invoice', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], on_delete=models.PROTECT))

        # Changing field 'Invoice.provider'
        db.alter_column(u'finance_invoice', 'provider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Provider'], on_delete=models.PROTECT))

        # Changing field 'InvoiceGoods.goods'
        db.alter_column(u'finance_invoicegoods', 'goods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], on_delete=models.PROTECT))

        # Changing field 'InvoiceGoods.invoice'
        db.alter_column(u'finance_invoicegoods', 'invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Invoice'], on_delete=models.PROTECT))

    def backwards(self, orm):
        # Deleting model 'IssuanceGoods'
        db.delete_table(u'finance_issuancegoods')

        # Deleting model 'Issuance'
        db.delete_table(u'finance_issuance')


        # Changing field 'Invoice.manager'
        db.alter_column(u'finance_invoice', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

        # Changing field 'Invoice.provider'
        db.alter_column(u'finance_invoice', 'provider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Provider']))

        # Changing field 'InvoiceGoods.goods'
        db.alter_column(u'finance_invoicegoods', 'goods_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods']))

        # Changing field 'InvoiceGoods.invoice'
        db.alter_column(u'finance_invoicegoods', 'invoice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Invoice']))
    ...
    models = {
        ...
        u'finance.goods': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
            'register_units': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['finance.RegisterUnits']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'})
        },
        ...
        u'finance.warehouse': {
            'Meta': {'object_name': 'Warehouse', '_ormbases': [u'finance.InvoiceGoods']},
            'balance': ('django.db.models.fields.IntegerField', [], {}),
            u'invoicegoods_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['finance.InvoiceGoods']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'person.client': {
