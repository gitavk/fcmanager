...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CashCheck'
        db.create_table(u'finance_cashcheck', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'finance', ['CashCheck'])

        # Adding field 'CreditsHistory.check'
        db.add_column(u'finance_creditshistory', 'check',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.CashCheck'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CashCheck'
        db.delete_table(u'finance_cashcheck')

        # Deleting field 'CreditsHistory.check'
        db.delete_column(u'finance_creditshistory', 'check_id')
