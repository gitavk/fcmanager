...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Trash'
        db.create_table(u'finance_trash', (
        ...
        db.send_create_signal(u'finance', ['Trash'])

        # Adding model 'TrashGoods'
        db.create_table(u'finance_trashgoods', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trash', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Trash'], on_delete=models.PROTECT)),
            ('goods', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], on_delete=models.PROTECT)),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ))
        db.send_create_signal(u'finance', ['TrashGoods'])


    def backwards(self, orm):
        # Deleting model 'Trash'
        db.delete_table(u'finance_trash')

        # Deleting model 'TrashGoods'
        db.delete_table(u'finance_trashgoods')
    ...
    models = {
        ...
        u'finance.creditshistory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['finance.CreditsHistory']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
