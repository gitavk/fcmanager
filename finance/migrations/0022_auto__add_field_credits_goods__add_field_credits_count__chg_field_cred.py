...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Credits.goods'
        db.add_column(u'finance_credits', 'goods',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'Credits.count'
        db.add_column(u'finance_credits', 'count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Credits.guest'
        db.alter_column(u'finance_credits', 'guest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.Guest'], null=True, on_delete=models.PROTECT))

        # Changing field 'Credits.contract'
        db.alter_column(u'finance_credits', 'contract_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.Contract'], null=True, on_delete=models.PROTECT))

        # Changing field 'Credits.client'
        db.alter_column(u'finance_credits', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Client'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):
        # Deleting field 'Credits.goods'
        db.delete_column(u'finance_credits', 'goods_id')

        # Deleting field 'Credits.count'
        db.delete_column(u'finance_credits', 'count')


        # Changing field 'Credits.guest'
        db.alter_column(u'finance_credits', 'guest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.Guest'], null=True))

        # Changing field 'Credits.contract'
        db.alter_column(u'finance_credits', 'contract_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contract.Contract'], null=True))

        # Changing field 'Credits.client'
        db.alter_column(u'finance_credits', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Client'], null=True))
