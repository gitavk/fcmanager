...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'RegisterUnits', fields ['name']
        db.create_unique(u'finance_registerunits', ['name'])

        # Adding unique constraint on 'GoodsType', fields ['name']
        db.create_unique(u'finance_goodstype', ['name'])

        # Adding unique constraint on 'Measure', fields ['name']
        db.create_unique(u'finance_measure', ['name'])

        # Adding unique constraint on 'Provider', fields ['name']
        db.create_unique(u'finance_provider', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Provider', fields ['name']
        db.delete_unique(u'finance_provider', ['name'])

        # Removing unique constraint on 'Measure', fields ['name']
        db.delete_unique(u'finance_measure', ['name'])

        # Removing unique constraint on 'GoodsType', fields ['name']
        db.delete_unique(u'finance_goodstype', ['name'])

        # Removing unique constraint on 'RegisterUnits', fields ['name']
        db.delete_unique(u'finance_registerunits', ['name'])
