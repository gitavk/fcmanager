...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'finance_invoice', 'number', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Invoice.number'
        db.alter_column(u'finance_invoice', 'number', self.gf('django.db.models.fields.IntegerField')())
