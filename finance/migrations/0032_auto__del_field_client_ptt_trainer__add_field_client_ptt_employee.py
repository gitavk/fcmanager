...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Client_PTT.trainer'
        db.delete_column(u'finance_client_ptt', 'trainer_id')

        # Adding field 'Client_PTT.employee'
        db.add_column(u'finance_client_ptt', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['employees.Employee'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Client_PTT.trainer'
        db.add_column(u'finance_client_ptt', 'trainer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['employees.Employee'], on_delete=models.PROTECT),
                      keep_default=False)

        # Deleting field 'Client_PTT.employee'
        db.delete_column(u'finance_client_ptt', 'employee_id')
