...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Goods.mix_measure'
        db.alter_column(u'finance_goods', 'mix_measure_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['finance.Measure']))

        # Changing field 'Goods.measure'
        db.alter_column(u'finance_goods', 'measure_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Measure'], null=True, on_delete=models.PROTECT))

        # Changing field 'Goods.register_units'
        db.alter_column(u'finance_goods', 'register_units_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.RegisterUnits'], null=True, on_delete=models.PROTECT))

        # Changing field 'Goods.goods_type'
        db.alter_column(u'finance_goods', 'goods_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.GoodsType'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Goods.mix_measure'
        db.alter_column(u'finance_goods', 'mix_measure_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['finance.Measure']))

        # Changing field 'Goods.measure'
        db.alter_column(u'finance_goods', 'measure_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Measure'], null=True))

        # Changing field 'Goods.register_units'
        db.alter_column(u'finance_goods', 'register_units_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.RegisterUnits'], null=True))

        # Changing field 'Goods.goods_type'
        db.alter_column(u'finance_goods', 'goods_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.GoodsType'], null=True))
