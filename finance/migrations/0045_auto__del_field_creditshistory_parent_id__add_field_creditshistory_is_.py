...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CreditsHistory.parent_id'
        db.delete_column(u'finance_creditshistory', 'parent_id_id')

        # Adding field 'CreditsHistory.is_return'
        db.add_column(u'finance_creditshistory', 'is_return',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CreditsHistory.date_return'
        db.add_column(u'finance_creditshistory', 'date_return',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CreditsHistory.user_return'
        db.add_column(u'finance_creditshistory', 'user_return',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ch_user_return', null=True, on_delete=models.PROTECT, to=orm['core.User']),
                      keep_default=False)


        # Changing field 'CreditsHistory.payment_date'
        db.alter_column(u'finance_creditshistory', 'payment_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'CreditsHistory.date'
        db.alter_column(u'finance_creditshistory', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Adding field 'CreditsHistory.parent_id'
        db.add_column(u'finance_creditshistory', 'parent_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.CreditsHistory'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Deleting field 'CreditsHistory.is_return'
        db.delete_column(u'finance_creditshistory', 'is_return')

        # Deleting field 'CreditsHistory.date_return'
        db.delete_column(u'finance_creditshistory', 'date_return')

        # Deleting field 'CreditsHistory.user_return'
        db.delete_column(u'finance_creditshistory', 'user_return_id')


        # Changing field 'CreditsHistory.payment_date'
        db.alter_column(u'finance_creditshistory', 'payment_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'CreditsHistory.date'
        db.alter_column(u'finance_creditshistory', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'contract.contract': {
            ...
            'bonus_visit': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        u'finance.client_ptt': {
            'Meta': {'object_name': 'Client_PTT'},
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['person.Client']", 'on_delete': 'models.PROTECT'}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employees.Employee']", 'on_delete': 'models.PROTECT'}),
            'goods': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['finance.Goods']", 'on_delete': 'models.PROTECT'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_card': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'payment_type': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
        ...
        u'finance.creditshistory': {
            ...
            'date_return': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'department': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employees.Employee']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'goods': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['finance.Goods']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'guest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reception.Guest']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_return': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            ...
            'ptt_card': ('django.db.models.fields.BigIntegerField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.User']"}),
            'user_return': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ch_user_return'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['core.User']"})
        },
        u'finance.goods': {
            'Meta': {'object_name': 'Goods'},
            'client_only': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'department': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            ...
            'single_visit': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'})
        },
        ...
        u'finance.trashgoods': {
            'Meta': {'object_name': 'TrashGoods'},
            'count': ('django.db.models.fields.IntegerField', [], {}),
            'goods': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['finance.Goods']", 'on_delete': 'models.PROTECT'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'trash': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['finance.Trash']", 'on_delete': 'models.PROTECT'})
        },
        u'person.client': {
