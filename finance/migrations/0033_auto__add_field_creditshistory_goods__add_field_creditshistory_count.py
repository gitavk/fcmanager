...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditsHistory.goods'
        db.add_column(u'finance_creditshistory', 'goods',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'CreditsHistory.count'
        db.add_column(u'finance_creditshistory', 'count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditsHistory.goods'
        db.delete_column(u'finance_creditshistory', 'goods_id')

        # Deleting field 'CreditsHistory.count'
        db.delete_column(u'finance_creditshistory', 'count')
