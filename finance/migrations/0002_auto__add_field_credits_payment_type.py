...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Credits.payment_type'
        db.add_column(u'finance_credits', 'payment_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Credits.payment_type'
        db.delete_column(u'finance_credits', 'payment_type')
