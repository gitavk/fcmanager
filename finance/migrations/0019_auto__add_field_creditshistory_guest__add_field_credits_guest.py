...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditsHistory.guest'
        db.add_column(u'finance_creditshistory', 'guest',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.Guest'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Credits.guest'
        db.add_column(u'finance_credits', 'guest',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reception.Guest'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditsHistory.guest'
        db.delete_column(u'finance_creditshistory', 'guest_id')

        # Deleting field 'Credits.guest'
        db.delete_column(u'finance_credits', 'guest_id')
