...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoodsType.name'
        db.alter_column(u'finance_goodstype', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150))

    def backwards(self, orm):

        # Changing field 'GoodsType.name'
        db.alter_column(u'finance_goodstype', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
