...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CreditsHistory.department'
        db.add_column(u'finance_creditshistory', 'department',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Credits.department'
        db.add_column(u'finance_credits', 'department',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CreditsHistory.department'
        db.delete_column(u'finance_creditshistory', 'department')

        # Deleting field 'Credits.department'
        db.delete_column(u'finance_credits', 'department')
