...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PositionPTT'
        db.create_table(u'finance_positionptt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Position'], on_delete=models.PROTECT)),
            ('goods', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['finance.Goods'], on_delete=models.PROTECT)),
        ))
        db.send_create_signal(u'finance', ['PositionPTT'])


    def backwards(self, orm):
        # Deleting model 'PositionPTT'
        db.delete_table(u'finance_positionptt')
