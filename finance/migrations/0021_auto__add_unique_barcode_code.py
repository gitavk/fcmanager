...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BarCode', fields ['code']
        db.create_unique(u'finance_barcode', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'BarCode', fields ['code']
        db.delete_unique(u'finance_barcode', ['code'])
