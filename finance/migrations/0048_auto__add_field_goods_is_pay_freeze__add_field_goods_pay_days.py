...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goods.is_pay_freeze'
        db.add_column(u'finance_goods', 'is_pay_freeze',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Goods.pay_days'
        db.add_column(u'finance_goods', 'pay_days',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goods.is_pay_freeze'
        db.delete_column(u'finance_goods', 'is_pay_freeze')

        # Deleting field 'Goods.pay_days'
        db.delete_column(u'finance_goods', 'pay_days')
    ...
    models = {
        ...
        u'contract.contract': {
            ...
            'is_current': ('django.db.models.fields.SmallIntegerField', [], {'default': '2'}),
        ...
        u'finance.creditshistory': {
            ...
            'amount': ('django.db.models.fields.FloatField', [], {}),
            'check': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['finance.CashCheck']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
        ...
        u'finance.goods': {
            ...
            'is_pay_freeze': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'pay_days': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
